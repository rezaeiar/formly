...
export default function Sidebar() {
    return (
        <div className='hidden sm:flex flex-col items-center xl:items-start justify-between bg-white border-r border-slate-200 xl:w-62 px-3.5 py-4.5 min-h-screen'>
